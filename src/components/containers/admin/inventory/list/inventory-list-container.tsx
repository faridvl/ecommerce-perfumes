            ...
            {!isLoading && !isError && products.length === 0 && (
              <tr>
                <td colSpan={5} className="px-6 py-16 text-center">
                  <PackageX size={40} className="mx-auto text-neutral-200 mb-3" />
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        {product.is_active
                          ? t(TEXT.ADMIN.INVENTORY.LIST.STATUS_ACTIVE)
                          : t(TEXT.ADMIN.INVENTORY.LIST.STATUS_INACTIVE)}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          title={t(TEXT.ADMIN.INVENTORY.LIST.ACTION_EDIT)}
                        >
                          <Pencil size={16} />
                        </button>
                        <button
                          ...
                          title={t(TEXT.ADMIN.INVENTORY.LIST.ACTION_DELETE)}
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
